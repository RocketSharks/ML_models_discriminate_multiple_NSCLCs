...
LastEditors: lx
LastEditTime: 2024-10-14 17:02:41
Description: 
FilePath: /test/DT.py
'''
...
if __name__ == '__main__':
    ...
    rfc = DecisionTreeClassifier(random_state=random_seed_)
    # 定义超参数超参数空间
    param_grid = {
    ...
    joblib.dump(GS.best_estimator_, f"DT.pkl")
    ...
    # 保存结果
    val_results_df.to_csv('./DT_val_results.csv', index=False)
    test_results_df.to_csv('./DT_test_results.csv', index=False)
